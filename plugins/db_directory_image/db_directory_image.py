...
import db_directory_generic.db_directory_generic as db_directory_generic_module


class db_directory_image(db_directory_generic_module.db_directory_generic):
...
#
    ...
    def __init__(self, relpath, fullpath, web_support, handler_support, caller, handlers, content_mode=_default_content_mode, style_mode=_default_style_mode, recursion_depth=_default_recursion_depth):
        ...
        super(db_directory_image, self).__init__(relpath, fullpath, web_support, handler_support, caller, handlers, content_mode, style_mode)
        pass
#
#    def getContent(self):
