...
class db_pdf_viewer(renderer_class):
    ...
    def getContent(self):
        if self._content_mode == "detailed":
            ...
            xmlroot = etree.Element('{http://thermal.cnde.iastate.edu/databrowse/pdf}pdf', xmlns="http://thermal.cnde.iastate.edu/databrowse/pdf", name=os.path.basename(self._relpath), href=link)
            return xmlroot
